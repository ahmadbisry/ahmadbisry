...
<div class="dropdown">
  ...
  <ul class="dropdown-menu">
    ...
    <input name="octaal" type="number" class="form-control" placeholder="Masukan Bilangan" value="<?=$octaal;?>" min="1" required>
  ...
  <div class="card bg-primary mb-3 text-white">
    <div class="p-2 card-body"><?=$octaal;?></div>
</div>

  <label>Binary</label>
  <div class="card mb-3">
    <div class="p-2 card-body"><?=$hitungbinar;?></div>
</div>

  <label>Decimal</label>
  <div class="card mb-3">
    <div class="p-2 card-body"><?=$decima;?></div>
</div>

<label>Hexadecimal</label>
  <div class="card">
    <div class="p-2 card-body"><?=$hitunghexam;?></div>
</div>
