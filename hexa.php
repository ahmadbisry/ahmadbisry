...
<div class="dropdown">
  ...
  <ul class="dropdown-menu">
    ...
    <input name="hexad" type="text" class="form-control" placeholder="Masukan Bilangan" value="<?=$hexad;?>" required>
  ...
  <div class="card bg-primary mb-3 text-white">
    <div class="p-2 card-body"><?=$hexad;?></div>
</div>

  <label>Binary</label>
  <div class="card mb-3">
    <div class="p-2 card-body"><?=$hitungbinary;?></div>
</div>

  <label>Decimal</label>
  <div class="card mb-3">
    <div class="p-2 card-body"><?=$decim;?></div>
</div>

<label>Octal</label>
  <div class="card">
    <div class="p-2 card-body"><?=$hitungoctall;?></div>
</div>
